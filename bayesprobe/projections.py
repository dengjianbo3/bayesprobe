...
def build_answer_projection(
    ...
    return AnswerProjection(
        ...
        answer_utility_notes="Generated by the autonomous controller after a single integrated cycle.",
    )
...
def build_belief_state_projection(
    ...
    uncertainty = (
        previous_belief_state.uncertainty_summary
        or "Source independence and rival separation still need attention."
    )
